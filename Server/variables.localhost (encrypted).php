...
define("_DB_","swsso-encrypted"); 		// Nom de la base de données
...
define("_AESPWD_","pacoivoij23987sqd");			// Mot de passe pour chiffrement
...
define("_MENUSUFFIX_","MENU");  // "protection" de l'URL presentant le menu
define("_READSUFFIX_","READ");  // "protection" des URLs permettant la lecture de la base
define("_WRITESUFFIX_","WRITE"); // "protection" des URLs permettant la modification de la base
?>