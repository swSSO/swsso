...
int Install(void)
{
    ...
    schService = CreateService( 
        ...
        "swSSORecoverSvc",                   // name of service 
        "swSSORecover service",                   // service name to display 
...
int Uninstall(void)
{
	...
	schService = OpenService(schSCManager, "swSSORecoverSvc", SERVICE_STOP | DELETE);
    if (schService==NULL)
	{
...
bool IsInstalled(void)
{
	...
	schService=OpenService(schSCManager, "swSSORecoverSvc", SERVICE_QUERY_CONFIG);
